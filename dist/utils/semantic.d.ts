 ...
 */
export declare function combineClasses(baseClass: string, semanticClass?: string): string;
/**
 * Helper to get style string or undefined
 */
export declare function getSemanticStyle(styles: SemanticStyles | undefined, key: string): string | undefined;
